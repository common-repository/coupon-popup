<div class="<?= $parent_class ?> <?= $theme_class ?>">

<?php
wp_enqueue_style('google-font-oxygen', '//fonts.googleapis.com/css?family=Oxygen');
ob_start();
?>
    ...
    <div class="<?=CouponPopup::$classPrefix;?>footer">
        ...
        <div class="<?=CouponPopup::$classPrefix;?>revealed">
            <?php if (isset($coupon['button'])): ?>
                <a href="<?= $coupon['url'] ?>" title="<?= $coupon['title']; ?>" target="_blank" class="coupon-popup-button" rel="nofollow"><?= $coupon['button_popup'] ?></a>
            <?php endif; ?>
